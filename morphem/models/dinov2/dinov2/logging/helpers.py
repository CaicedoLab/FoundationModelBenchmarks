...
from dinov2.configs.config import Dinov2Config, WandbMode
...
class MetricLogger(object):
    ...
    def log_every(self, iterable, print_freq, config: Dinov2Config, header=None, n_iterations=None, start_iteration=0):            
        if distributed.is_main_process():
            mode = None if config.train.wandb_mode == WandbMode.enabled else 'disabled'
